...
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) [`cluster-autoscaler-chart-9.46.3`](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-chart-9.46.3) - Autoscaling components for Kubernetes
- [oauth2-proxy/manifests](https://github.com/oauth2-proxy/manifests) [`oauth2-proxy-7.12.6`](https://github.com/oauth2-proxy/manifests/releases/tag/oauth2-proxy-7.12.6) - Helm charts to allow for the deployment of OAuth2-Proxy
