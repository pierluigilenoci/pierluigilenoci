...
- [oauth2-proxy/manifests](https://github.com/oauth2-proxy/manifests) [`oauth2-proxy-8.5.0`](https://github.com/oauth2-proxy/manifests/releases/tag/oauth2-proxy-8.5.0) - Helm charts to allow for the deployment of OAuth2-Proxy
