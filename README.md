...
- [oauth2-proxy/manifests](https://github.com/oauth2-proxy/manifests) [`oauth2-proxy-7.5.4`](https://github.com/oauth2-proxy/manifests/releases/tag/oauth2-proxy-7.5.4) - For hosting manifests to allow for the deployment of OAuth2-Proxy/OAuth2-Proxy
- [crossplane/crossplane](https://github.com/crossplane/crossplane) [`v1.16.0-rc.1`](https://github.com/crossplane/crossplane/releases/tag/v1.16.0-rc.1) - The Cloud Native Control Plane
