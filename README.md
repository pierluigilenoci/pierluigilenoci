...
- [oauth2-proxy/manifests](https://github.com/oauth2-proxy/manifests) [`oauth2-proxy-7.0.0`](https://github.com/oauth2-proxy/manifests/releases/tag/oauth2-proxy-7.0.0) - For hosting manifests to allow for the deployment of OAuth2-Proxy/OAuth2-Proxy
