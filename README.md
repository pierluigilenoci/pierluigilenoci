...
- [oauth2-proxy/manifests](https://github.com/oauth2-proxy/manifests) [`oauth2-proxy-7.12.18`](https://github.com/oauth2-proxy/manifests/releases/tag/oauth2-proxy-7.12.18) - Helm charts to allow for the deployment of OAuth2-Proxy
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) [`vertical-pod-autoscaler-1.4.1`](https://github.com/kubernetes/autoscaler/releases/tag/vertical-pod-autoscaler-1.4.1) - Autoscaling components for Kubernetes
