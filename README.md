...
- [oauth2-proxy/manifests](https://github.com/oauth2-proxy/manifests) [`oauth2-proxy-10.4.0`](https://github.com/oauth2-proxy/manifests/releases/tag/oauth2-proxy-10.4.0) - Helm charts to allow for the deployment of OAuth2-Proxy
- [alibaba/nacos](https://github.com/alibaba/nacos) [`3.1.2`](https://github.com/alibaba/nacos/releases/tag/3.1.2) - an easy-to-use dynamic service discovery, configuration and service management platform for building AI cloud native applications.
