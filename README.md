...
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) [`cluster-autoscaler-chart-9.46.0`](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-chart-9.46.0) - Autoscaling components for Kubernetes
