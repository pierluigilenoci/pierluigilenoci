...
- [oauth2-proxy/manifests](https://github.com/oauth2-proxy/manifests) [`oauth2-proxy-8.3.2`](https://github.com/oauth2-proxy/manifests/releases/tag/oauth2-proxy-8.3.2) - Helm charts to allow for the deployment of OAuth2-Proxy
...
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) [`vertical-pod-autoscaler-chart-0.5.0`](https://github.com/kubernetes/autoscaler/releases/tag/vertical-pod-autoscaler-chart-0.5.0) - Autoscaling components for Kubernetes
