...
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) [`cluster-autoscaler-chart-9.43.3`](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-chart-9.43.3) - Autoscaling components for Kubernetes
- [oauth2-proxy/manifests](https://github.com/oauth2-proxy/manifests) [`oauth2-proxy-7.8.3`](https://github.com/oauth2-proxy/manifests/releases/tag/oauth2-proxy-7.8.3) - For hosting manifests to allow for the deployment of OAuth2-Proxy/OAuth2-Proxy
