...
- [oauth2-proxy/manifests](https://github.com/oauth2-proxy/manifests) [`oauth2-proxy-7.12.16`](https://github.com/oauth2-proxy/manifests/releases/tag/oauth2-proxy-7.12.16) - Helm charts to allow for the deployment of OAuth2-Proxy
