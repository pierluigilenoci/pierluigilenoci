...
- [oauth2-proxy/manifests](https://github.com/oauth2-proxy/manifests) [`oauth2-proxy-7.15.1`](https://github.com/oauth2-proxy/manifests/releases/tag/oauth2-proxy-7.15.1) - Helm charts to allow for the deployment of OAuth2-Proxy
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) [`cluster-autoscaler-1.32.2`](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-1.32.2) - Autoscaling components for Kubernetes
